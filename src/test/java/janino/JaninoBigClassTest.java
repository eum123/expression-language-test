 ...
 *
 */
public class JaninoBigClassTest {
    /**
    ...
    public void big() throws Exception {
         ...
         * file size : 11,908,288
         * ---------------------------------------------
         * ns         %     Task name
         * ---------------------------------------------
         * 033674625  000%  create
         * 10559969750  098%  compile
         * 002705833  000%  file write
         * 004642500  000%  class load
         * 212160958  002%  execute
         */
